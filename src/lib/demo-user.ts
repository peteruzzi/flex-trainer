...
export const DEMO_USER_EMAIL = "peter@demo.flextrainer.app";
export const DEMO_USER_NAME = "Peter";
...
export async function getOrCreateDemoUser() {
  ...
  if (!user) {
    ...
    // Seed initial workouts for demo user
...
export async function seedDemoWorkouts(userId: string) {
  ...
  const existingCount = await prisma.workout.count({ where: { userId } });
